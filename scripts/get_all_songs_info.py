...
if __name__ == '__main__':  # TODO - verbosity!!
    ...
    for song_obj in song_objects:
        ...
        if artist_name not in artist_songs.keys():
        ...
        artist_songs[artist_name].append(song_obj)
    ...
    # [artist.get_noun_to_adj_ratio_hist_plot() for artist in artist_songs.values()]
    print('[[ DONE ]]')
